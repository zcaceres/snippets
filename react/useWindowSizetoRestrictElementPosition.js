 ...
 *
 * At most, it will be `MIN_DISTANCE_FROM_EDGE_PX` away from the right or top edge of the window.
 *
 * By default the absolute positioned element will be to the bottom right corner of the parent element.
 * But it will adapt to the window and move the absolute positioned element to the right corner.
 *
